...
CREATE (hat:product:headphones { key:'product1', name:'noise cancelling headphones' })-[:class_of]->product
CREATE (hat:product:coffeemug { key:'product1', name:'i heart neo4j coffee mug' })-[:class_of]->product
...
CREATE (view3:event:view { key:'view3', verb:'view', past:'has viewed', present:'is viewing', future:'will view' })-[:event]->d19 
CREATE (view4:event:view { key:'view4', verb:'view', past:'has viewed', present:'is viewing', future:'will view' })-[:event]->d20 
CREATE (view5:event:view { key:'view5', verb:'view', past:'has viewed', present:'is viewing', future:'will view' })-[:event]->d21 
CREATE (buy0:event:buy { key:'buy0', verb:'buy', past:'bought', present:'is buying', future:'will buy' })-[:event]->d18 
CREATE (buy1:event:buy { key:'buy1', verb:'buy', past:'bought', present:'is buying', future:'will buy' })-[:event]->d23 
...
CREATE pam-[:event]->view3-[:event]->headphones
...
Let's find products that other people viewed who also viewed Sombreros.

//output
[source,cypher]
----
MATCH p=(p0:person)-[:event]->(ev:buy)-[:event]->(p1:product) 
WITH p0, p1 
WHERE p1.name = 'sombrero' 
WITH p0 
MATCH p0-[:event]->(ev:view)-[:event]->(p2:product) 
WHERE p2.name <> 'sombrero' 
RETURN p2.name
----
