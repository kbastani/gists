...
This is the first of two GraphGists that respond to Sarah's blog post. If you would like to quickly jump to the second one that details the social networking data model, you can find it here: [link]
